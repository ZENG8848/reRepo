<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign.aspx.cs" Inherits="reCruit.pages.sign" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p class="auto-style3">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            Confirm Password:<asp:TextBox ID="txtpsd2" runat="server"></asp:TextBox>
